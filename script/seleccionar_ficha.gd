...
@export var ficha1 : String = "https://res.cloudinary.com/dj3xwsle9/image/upload/v1732106777/ficha_zorro_ize9ec.png"
@export var ficha2 : String = "https://res.cloudinary.com/dj3xwsle9/image/upload/v1732106777/ficha_le%C3%B3n_xry2ff.png"
@export var ficha3 : String = "https://res.cloudinary.com/dj3xwsle9/image/upload/v1732106777/ficha_conejo_mmdfgb.png" 
@export var ficha4 : String = "https://res.cloudinary.com/dj3xwsle9/image/upload/v1732106777/ficha_gato_hugghg.png"
...
func _on_button_1_pressed() -> void:
	SelectedCharacter.selected_ficha = ficha1
	get_tree().change_scene_to_file("res://scenes/vista_1_2.1.tscn")


func _on_button_2_pressed() -> void:
	SelectedCharacter.selected_ficha = ficha2
	get_tree().change_scene_to_file("res://scenes/vista_1_2.1.tscn")


func _on_button_3_pressed() -> void:
	SelectedCharacter.selected_ficha = ficha3
	get_tree().change_scene_to_file("res://scenes/vista_1_2.1.tscn")


func _on_button_4_pressed() -> void:
	SelectedCharacter.selected_ficha = ficha4
	get_tree().change_scene_to_file("res://scenes/vista_1_2.1.tscn")
